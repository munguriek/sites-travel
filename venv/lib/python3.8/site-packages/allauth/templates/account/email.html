...
<div class="buttonHolder">
      ...
      <button class="secondaryAction btn btn-primary mx-3" type="submit" name="action_send" >{% trans 'Re-send Verification' %}</button>
...
{% endif %}
  ...
  {% if can_add_email %}
    <h2 class="my-3">{% trans "Add E-mail Address" %}</h2>
