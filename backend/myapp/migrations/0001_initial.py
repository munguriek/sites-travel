    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flight_type', models.CharField(choices=[('one way', 'one way'), ('return', 'return')], max_length=30)),
                ...
                ('car_hire', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.carhire')),
